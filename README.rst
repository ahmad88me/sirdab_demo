...
.. code-block:: bash
    ...
    heroku run python sirdab/manage.py syncdb --noinput --settings=config.settings
    heroku run python sirdab/manage.py migrate --settings=config.settings
    heroku run python sirdab/manage.py collectstatic --settings=config.settings
